...
type joins[Q dialect.Joinable] struct {
	LocationVersions joinSet[locationVersionJoins[Q]]
...
func getJoins[Q dialect.Joinable]() joins[Q] {
	return joins[Q]{
		LocationVersions: buildJoinSet[locationVersionJoins[Q]](LocationVersions.Columns, buildLocationVersionJoins),
