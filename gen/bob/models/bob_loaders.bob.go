...
type preloaders struct {
	LocationVersion locationVersionPreloader
	Location        locationPreloader
}

func getPreloaders() preloaders {
	return preloaders{
		LocationVersion: buildLocationVersionPreloader(),
...
type thenLoaders[Q orm.Loadable] struct {
	LocationVersion locationVersionThenLoader[Q]
	Location        locationThenLoader[Q]
}

func getThenLoaders[Q orm.Loadable]() thenLoaders[Q] {
	return thenLoaders[Q]{
		LocationVersion: buildLocationVersionThenLoader[Q](),
